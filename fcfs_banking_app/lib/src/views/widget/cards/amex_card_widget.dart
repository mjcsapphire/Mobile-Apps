...
class AmexCardWidget extends StatelessWidget {
  final String cardHolderName;
  final String cardNumber;
  final String expiryDate;
  final String bankName;

  const AmexCardWidget({
    super.key,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF080C17), Color(0xFF151C29)],
...
class AmexCardBackWidget extends StatelessWidget {
  final String cvv;
  final String terms;
  final String condition;

  const AmexCardBackWidget({
    super.key,
    required this.cvv,
    required this.terms,
